...
public class AgentRegistryService extends Service {
  ...
  @ApiResponses({
    @ApiResponse(code = 200, message = "The response contains requested agent entity"),
  ...
  public Agent getByName(
      @ApiParam("The agent id") @PathParam("id") String id,
      @ApiParam("The agent version") @PathParam("version") String version)
      throws ApiException {
    try {
  ...
  @Produces(APPLICATION_JSON)
  @ApiOperation(
    value = "Get a list of available versions of the giving agent",
    response = List.class
  )
  @ApiResponses({
    @ApiResponse(
      code = 200,
      message = "The response contains available versions of the giving agent"
    ),
    @ApiResponse(code = 404, message = "Agent not found"),
    @ApiResponse(code = 500, message = "Internal server error occurred")
  })
  public List<String> getVersions(@ApiParam("The agent id") @PathParam("id") String id)
      throws ApiException {
    try {
  ...
  @ApiResponses({
    @ApiResponse(code = 200, message = "The response contains collection of available agents"),
    @ApiResponse(code = 500, message = "Internal server error occurred")
  })
