...
/**
 * Checks readiness of ssh via sending global request. For more details see <a
 * href="https://tools.ietf.org/html/rfc4254">RFC-4254</a>.
 *
  ...
  public boolean isLaunched(Agent agent, InstanceProcess process, Instance machine)
    ...
    if (server != null) {
      try {
        ...
        try (Socket socket =
                new Socket(sshServerHostAndPort[0], Integer.parseInt(sshServerHostAndPort[1]));
