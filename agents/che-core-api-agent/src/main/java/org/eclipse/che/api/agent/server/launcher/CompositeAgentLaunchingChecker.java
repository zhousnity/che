...
/**
 * Verifies that agent was started successfully by calling verification of several specified
 * verifiers. Verification passes if and only if all verifiers pass verification.
 *
...
public class CompositeAgentLaunchingChecker implements AgentLaunchingChecker {
  ...
  public CompositeAgentLaunchingChecker(AgentLaunchingChecker... agentLaunchingCheckers) {
    checkArgument(
        agentLaunchingCheckers != null && agentLaunchingCheckers.length > 0,
