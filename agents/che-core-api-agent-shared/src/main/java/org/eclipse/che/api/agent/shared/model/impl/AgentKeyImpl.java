...
public class AgentKeyImpl implements AgentKey {
  ...
  /**
   * Factory method. Agent key is basically a string meeting the format: {@code id:version}. The
   * version part can be omitted.
   *
   * @throws IllegalArgumentException in case of wrong format
   */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(id, agentKey.id) && Objects.equals(version, agentKey.version);
  }
  ...
  public String toString() {
    return "AgentImpl{" + "id='" + id + '\'' + ", version='" + version + "\'}";
  }
}
