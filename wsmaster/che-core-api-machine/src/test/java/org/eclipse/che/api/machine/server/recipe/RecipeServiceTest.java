...
public class RecipeServiceTest {
  ...
  public void shouldBeAbleToGetRecipeScript() throws Exception {
    final RecipeImpl recipe =
        new RecipeImpl().withCreator("other-user").withId("recipe123").withScript("FROM ubuntu\n");
  ...
  public void shouldBeAbleToUpdateRecipe() throws Exception {
    final RecipeImpl recipe =
        new RecipeImpl()
            ...
            .withScript("script1 content")
            .withTags(asList("java"));
    final RecipeImpl updatedRecipe =
        new RecipeImpl(recipe)
            .withType("new-type")
