...
public interface InstanceProvider {
   ...
   * org.eclipse.che.api.core.model.machine.MachineSource} data in {@link
   * org.eclipse.che.api.core.model.machine.MachineConfig}.
   *
   ...
   * @throws NotFoundException if instance described by {@link
   *     org.eclipse.che.api.core.model.machine.MachineSource} doesn't exists
   * @throws MachineException if other error occurs
   */
  Instance createInstance(Machine machine, LineConsumer creationLogsOutput)
      throws UnsupportedRecipeException, InvalidRecipeException, SourceNotFoundException,
          NotFoundException, MachineException;
