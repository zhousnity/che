...
public final class DtoConverter {
  ...
  public static MachineConfigDto asDto(MachineConfig config) {
    return newDto(MachineConfigDto.class)
        ...
        .withServers(
            config.getServers().stream().map(DtoConverter::asDto).collect(Collectors.toList()))
  ...
  public static MachineSourceDto asDto(MachineSource source) {
    return newDto(MachineSourceDto.class)
  ...
  public static MachineDto asDto(Machine machine) {
    final MachineDto machineDto =
        newDto(MachineDto.class)
            .withConfig(asDto(machine.getConfig()))
  ...
  private static MachineRuntimeInfoDto asDto(MachineRuntimeInfo runtime) {
    final Map<String, ServerDto> servers =
        runtime
            .getServers()
            .entrySet()
            .stream()
    ...
    return newDto(MachineRuntimeInfoDto.class)
        .withEnvVariables(runtime.getEnvVariables())
  ...
  public static ServerPropertiesDto asDto(ServerProperties serverProperties) {
    return newDto(ServerPropertiesDto.class)
        .withPath(serverProperties.getPath())
  ...
  public static ServerConfDto asDto(ServerConf serverConf) {
    return newDto(ServerConfDto.class)
        .withRef(serverConf.getRef())
  ...
  public static MachineProcessDto asDto(MachineProcess machineProcess) {
    return newDto(MachineProcessDto.class)
        .withPid(machineProcess.getPid())
