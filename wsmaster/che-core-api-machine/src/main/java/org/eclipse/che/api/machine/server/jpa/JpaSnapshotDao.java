...
public class JpaSnapshotDao implements SnapshotDao {
  ...
  @Override
  @Transactional
  public SnapshotImpl getSnapshot(String workspaceId, String envName, String machineName)
    ...
    try {
      ...
      throw new NotFoundException(
          format(
              "Snapshot for machine '%s:%s:%s' doesn't exist", workspaceId, envName, machineName));
    } catch (RuntimeException x) {
      throw new SnapshotException(x.getLocalizedMessage(), x);
    }
  }
  ...
  @Override
  public List<SnapshotImpl> replaceSnapshots(
