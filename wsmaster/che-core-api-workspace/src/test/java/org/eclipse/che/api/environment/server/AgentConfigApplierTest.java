...
public class AgentConfigApplierTest {
  ...
  @Mock private AgentSorter sorter;
  @Mock private Instance machine;
  @Mock private AgentImpl agent1;
  @Mock private AgentImpl agent2;
  @Mock private AgentImpl agent3;
  @Mock private AgentLauncherFactory agentLauncher;
  ...
  public void shouldAddLabels() throws Exception {
    ...
    agentConfigApplier.apply(
        new ExtendedMachineImpl(singletonList("agent1"), emptyMap(), emptyMap()), service);
  ...
  public void shouldAddExposedPorts() throws Exception {
    ...
    agentConfigApplier.apply(
        new ExtendedMachineImpl(asList("agent1", "agent2", "agent3"), emptyMap(), emptyMap()),
        service);
