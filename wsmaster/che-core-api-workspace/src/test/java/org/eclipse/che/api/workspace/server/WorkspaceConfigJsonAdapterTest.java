...
public class WorkspaceConfigJsonAdapterTest {
  ...
  public void testNotValidWorkspaceConfigAdaptations(String filename) throws Exception {
    ...
    new WorkspaceConfigJsonAdapter()
        .adaptModifying(new JsonParser().parse(content).getAsJsonObject());
  }

  @DataProvider
  public static Object[][] invalidConfigs() throws Exception {
    final URL dir =
        Thread.currentThread().getContextClassLoader().getResource(INVALID_CONFIGS_DIR_NAME);
    assertNotNull(dir);
