...
public class WsAgentPingRequestFactoryTest {
  private static final int WS_AGENT_PING_CONNECTION_TIMEOUT_MS = 20;
  private static final String WS_AGENT_URL_IS_NOT_VALID =
  ...
  @Test(
    ...
    expectedExceptionsMessageRegExp = WS_AGENT_SERVER_NOT_FOUND_ERROR
  )
  ...
  @Test(
    expectedExceptions = ServerException.class,
    expectedExceptionsMessageRegExp = WS_AGENT_URL_IS_NOT_VALID
  )
