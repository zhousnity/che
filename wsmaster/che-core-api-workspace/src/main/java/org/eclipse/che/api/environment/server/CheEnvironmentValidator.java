...
public class CheEnvironmentValidator {
  ...
  private static final Pattern LINK_PATTERN =
      Pattern.compile(
          "^(?<serviceName>" + MACHINE_NAME_REGEXP + ")(:" + MACHINE_NAME_REGEXP + ")?$");
    ...
    service
        ...
        .forEach(
            link -> {
              ...
              checkArgument(
                  servicesNames.contains(serviceFromLink),
  ...
  private void validateExtendedMachine(
      ExtendedMachine extendedMachine, String envName, String machineName) {
