...
public class WorkspaceConfigJsonAdapter {
  ...
  /**
   * Adapts given workspace configuration environments to a new format, if it contains environments
   * array, otherwise does nothing.
   *
   * @throws IllegalArgumentException if the old format is bad, and can't be converted to a new one
   */
