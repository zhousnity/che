...
/**
 * Adds exec agent into each environment in stack where terminal agent is present. It is needed for
 * backward compatibility of application behavior after separation of these agents.
 *
