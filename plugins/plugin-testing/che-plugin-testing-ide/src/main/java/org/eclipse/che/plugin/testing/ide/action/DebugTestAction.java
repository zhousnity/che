...
public class DebugTestAction extends RunDebugTestAbstractAction {
  ...
  public void actionPerformed(ActionEvent e) {
    final StatusNotification notification =
        new StatusNotification("Debugging Tests...", PROGRESS, FLOAT_MODE);
    ...
    testResultPromise
        .onSuccess(result -> onTestRanSuccessfully(result, eventsProcessor, notification))
  ...
  private void runRemoteJavaDebugger(GeneralTestingEventsProcessor eventsProcessor, int port) {
    DebugConfiguration debugger =
        debugConfigurationsManager.createConfiguration(
            "jdb", frameworkAndTestName.first, "localhost", port, emptyMap());
