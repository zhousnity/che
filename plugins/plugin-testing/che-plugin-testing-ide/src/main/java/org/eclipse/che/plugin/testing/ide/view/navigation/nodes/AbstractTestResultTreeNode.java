 ...
 */
public abstract class AbstractTestResultTreeNode extends AbstractTreeNode
    implements HasPresentation {
  ...
  private static final String TEXT_INFO_CSS =
      "color: " + getEditorInfoTextColor() + "; font-size: 11px";

  public AbstractTestResultTreeNode(
