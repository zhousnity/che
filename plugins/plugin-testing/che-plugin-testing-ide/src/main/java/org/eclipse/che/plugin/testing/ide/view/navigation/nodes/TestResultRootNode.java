...
public class TestResultRootNode extends AbstractTestResultTreeNode {
  ...
  public String getTestInfoText() {
    if (testResultRootDto.getInfoText() != null) return testResultRootDto.getInfoText();
    return null;
  }
  ...
  protected Promise<List<Node>> getChildrenImpl() {
    ...
    Promise<List<TestResultDto>> promise =
        testServiceClient.getTestResults(frameworkName, testResultRootDto.getResultPath());
    return promise.then(
