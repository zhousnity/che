...
public class DockerAbandonedResourcesCleanerTest {
  ...
  @Mock private ContainerNameInfo containerNameInfo1;
  @Mock private ContainerNameInfo containerNameInfo2;
  @Mock private ContainerNameInfo containerNameInfo3;
  ...
  public void setUp() throws Exception {
    ...
    when(environmentEngine.getMachine(workspaceId2, machineId2))
  ...
  @Test
  public void
      cleanerShouldNotKillAndRemoveContainerIfMachineManagerDetectedExistingThisContainerInTheAPI()
          throws Exception {
  ...
  @Test
  public void cleanerShouldNotKillAndRemoveContainerIfContainerNameInfoIsEmpty()
      throws IOException {
  ...
  @Test
  public void shouldNotRemoveNetworkIfItInAdditionalNetworksListAndHasNameAsNetworkToRemove()
      throws IOException {
    // given
