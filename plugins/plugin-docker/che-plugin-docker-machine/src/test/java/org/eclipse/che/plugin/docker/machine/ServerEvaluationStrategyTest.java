...
public class ServerEvaluationStrategyTest {
  ...
  public void shouldIgnoreMultiplePortBindingEntries() throws Exception {
    ...
    ports.put(
        ...
        Arrays.asList(
            new PortBinding().withHostIp(ALL_IP_ADDRESS).withHostPort("32100"),
            new PortBinding().withHostIp(DEFAULT_HOSTNAME).withHostPort("32102")));
    ports.put(
        "9090/udp",
        Arrays.asList(
            new PortBinding().withHostIp(ALL_IP_ADDRESS).withHostPort("32101"),
            new PortBinding().withHostIp(ALL_IP_ADDRESS).withHostPort("32103"),
            new PortBinding().withHostIp(DEFAULT_HOSTNAME).withHostPort("32104")));
    Map<String, String> expected = new HashMap<>();
    expected.put("8080/tcp", DEFAULT_HOSTNAME + ":" + "32100");
    expected.put("9090/udp", DEFAULT_HOSTNAME + ":" + "32101");
  ...
  public void shouldAllowToUsePortFromDockerLabelsWithoutTransportProtocol() throws Exception {
    ...
    expectedServers.put(
        ...
        new ServerImpl(
            ...
            new ServerPropertiesImpl(
                null, DEFAULT_HOSTNAME + ":32101", "tftp://" + DEFAULT_HOSTNAME + ":32101")));
  ...
  public void shouldAddPathCorrectlyWithoutLeadingSlash() throws Exception {
    ...
    serverConfs.put("8080", new ServerConfImpl("myserv1", "8080", "http", "some"));
    serverConfs.put(
        "9090/udp", new ServerConfImpl("myserv1-tftp", "9090/udp", "tftp", "some/path"));
