...
public class DockerfileEnvironmentParserTest {
  ...
  @InjectMocks public DockerfileEnvironmentParser parser;
  ...
  public void shouldBeAbleToParseDockerfileEnvironmentFromLocation() throws Exception {
    ...
    EnvironmentImpl environment =
        createDockerfileEnvConfig(null, recipeLocation, DEFAULT_MACHINE_NAME);
    ...
    expected
        ...
        .put(
            DEFAULT_MACHINE_NAME,
            new CheServiceImpl()
                .withBuild(new CheServiceBuildContextImpl().withContext(recipeLocation)));
  ...
  public void shouldThrowExceptionOnParseOfDockerfileEnvWithSeveralExtendedMachines()
      throws Exception {
    // given
