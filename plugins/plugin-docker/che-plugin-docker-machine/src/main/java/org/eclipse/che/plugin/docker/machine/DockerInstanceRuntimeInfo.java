 ...
 *
 * <p>Contributors: Codenvy, S.A. - initial API and implementation Red Hat Inc. - refactor
 * getServers() method *****************************************************************************
 */
...
public class DockerInstanceRuntimeInfo implements MachineRuntimeInfo {
  ...
  /**
   * Environment variable that will contain ID of a workspace for which this machine has been
   * created
   */
  ...
  @Inject
  public DockerInstanceRuntimeInfo(
    ...
    Stream<ServerConf> confStream =
        Stream.concat(machineConfig.getServers().stream(), allMachinesSystemServers.stream());
