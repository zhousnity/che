 ...
 * ServerImpl} with internal addresses set to the container's address within the internal docker
 * network. If the server cannot directly ping the container, communication will fail.
 *
