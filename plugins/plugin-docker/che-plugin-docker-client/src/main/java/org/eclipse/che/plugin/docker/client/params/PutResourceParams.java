 ...
 * org.eclipse.che.plugin.docker.client.DockerConnector#putResource(PutResourceParams)}.
 *
...
public class PutResourceParams {
   ...
   *     container using {@link
   *     org.eclipse.che.plugin.docker.client.DockerConnector#getResource(GetResourceParams)}
   * @return this params instance
