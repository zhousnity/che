...
/**
 * Test deserialization field {@link ComposeServiceImpl#command} by {@link
 * org.eclipse.che.plugin.docker.compose.yaml.deserializer.CommandDeserializer} in the {@link
...
public class CommandDeserializerTest {
  ...
  @Test(expectedExceptions = IllegalArgumentException.class, dataProvider = "inValidCommand")
