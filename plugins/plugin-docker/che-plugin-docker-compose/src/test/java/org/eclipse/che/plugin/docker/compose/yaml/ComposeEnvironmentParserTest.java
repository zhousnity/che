...
public class ComposeEnvironmentParserTest {
  ...
  @Test
  public void shouldBeAbleToParseComposeEnvironmentWithApplicationByLocation()
  ...
  private CheServicesEnvironmentImpl createTestEnv() {
    ...
    cheServicesEnvironment.setServices(
        ImmutableMap.of(
            "machine1", cheService1,
