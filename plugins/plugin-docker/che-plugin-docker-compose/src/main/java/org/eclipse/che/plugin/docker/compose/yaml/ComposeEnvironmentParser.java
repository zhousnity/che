 ...
 * Environment} to {@link CheServicesEnvironmentImpl}.
 *
...
public class ComposeEnvironmentParser implements TypeSpecificEnvironmentParser {
   ...
   *
   * @param environment environment with {@link EnvironmentRecipe} to parse. {@link
   *     EnvironmentRecipe} contains {@link CheServicesEnvironmentImpl} definition.
   * @throws IllegalArgumentException when environment or environment recipe is invalid
   * @throws ServerException when environment recipe can not be retrieved
   */
  @Override
   ...
   * @throws IllegalArgumentException when argument is null or conversion to YAML fails
   */
