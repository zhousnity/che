...
public class OpenShiftConnector extends DockerConnector {
  ...
  public ContainerCreated createContainer(CreateContainerParams createContainerParams)
    ...
    Set<String> containerExposedPorts =
        createContainerParams.getContainerConfig().getExposedPorts().keySet();
    Set<String> imageExposedPorts =
        inspectImage(InspectImageParams.create(imageForDocker))
            .getConfig()
            .getExposedPorts()
            .keySet();
    ...
    try {
      createOpenShiftService(
          deploymentName, serviceName, exposedPorts, additionalLabels, endpointAliases);
  ...
  private Set<String> getExposedPorts(
      Set<String> containerExposedPorts, Set<String> imageExposedPorts) {
