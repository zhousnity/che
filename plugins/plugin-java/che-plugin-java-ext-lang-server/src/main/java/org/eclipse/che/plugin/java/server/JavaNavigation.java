...
public class JavaNavigation {
  ...
  public List<JarEntry> getPackageFragmentRootContent(IJavaProject project, int hash)
      throws JavaModelException {
   ...
   *
   * @param javaProject path to the project which is contained class file
   * @param fqn fully qualified name of the class file
   * @param isShowingInheritedMembers <code>true</code> iff inherited members are shown
   * @return instance of {@link CompilationUnit}
   * @throws JavaModelException when JavaModel has a failure
   */
  public CompilationUnit getCompilationUnitByPath(
      IJavaProject javaProject, String fqn, boolean isShowingInheritedMembers)
      throws JavaModelException {
    ...
    compilationUnit.setLabel(
        org.eclipse.jdt.ui.JavaElementLabels.getElementLabel(
            unit, org.eclipse.jdt.ui.JavaElementLabels.ALL_DEFAULT));
  ...
  private Field convertToDTOField(IField iField) throws JavaModelException {
    ...
    field.setLabel(
        org.eclipse.jdt.ui.JavaElementLabels.getElementLabel(
            iField, org.eclipse.jdt.ui.JavaElementLabels.ALL_DEFAULT));
  ...
  private IPackageFragmentRoot getPackageFragmentRoot(IJavaProject project, int hash)
      throws JavaModelException {
  ...
  private List<JarEntry> convertToJarEntry(Object[] rootContent, IPackageFragmentRoot root)
      throws JavaModelException {
  ...
  protected Object[] getPackageContent(IPackageFragment fragment) throws JavaModelException {
    ...
    if (result.isEmpty()) return nonPackages;
  ...
  private OpenDeclarationDescriptor compilationUnitNavigation(
      ICompilationUnit unit, IJavaElement element) throws JavaModelException {
    OpenDeclarationDescriptor dto =
        DtoFactory.getInstance().createDto(OpenDeclarationDescriptor.class);
  ...
  public List<JarEntry> getChildren(IJavaProject project, int rootId, String path)
      throws JavaModelException {
  ...
  public ClassContent getContent(IJavaProject project, int rootId, String path)
