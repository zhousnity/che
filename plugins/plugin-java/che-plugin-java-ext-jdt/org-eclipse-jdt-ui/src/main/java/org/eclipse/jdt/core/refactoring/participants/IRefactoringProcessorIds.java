...
public interface IRefactoringProcessorIds {
  ...
  /**
   * Processor ID of the Change Method Signature processor (value <code>
   * "org.eclipse.jdt.ui.changeMethodSignatureRefactoring"</code>).
   *
   * <p>The Change Method Signature processor loads {@link ChangeMethodSignatureParticipant}s
   ...
   * "org.eclipse.jdt.ui.introduceParameterObjectRefactoring"</code>).
   *
   * <p>The Introduce Parameter Object processor loads {@link ChangeMethodSignatureParticipant}s
   * registered for the <code>IMethod</code> whose signature is changed.
   */
