...
/**
 * Copies a tree of text edits. A text edit copier keeps a map between original and new text edits.
 * It can be used to map a copy back to its original edit.
 */
public final class TextEditCopier {
  ...
  /**
   * Constructs a new <code>TextEditCopier</code> for the given edit. The actual copy is done by
   * calling <code>
   * perform</code>.
   *
   ...
   * @return the copy of the original edit or <code>null</code> if the original isn't managed by
   *     this copier
   */
