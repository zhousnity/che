 ...
 *
 * <p>This implementation uses an unmodifiable text store for the initial content. Upon first
...
public class CopyOnWriteTextStore implements TextStore {
   ...
   * Trying to {@link #replace} a text range or {@link #set} new content will throw an <code>
   ...
   *
   * @param modifiableTextStore a modifiable <code>ITextStore</code> instance, may not be <code>null
   *     </code>
   */
