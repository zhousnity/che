...
/**
 * A copy source edit denotes the source of a copy operation. Copy source edits are only valid
 ...
 *
 * <p>A copy source edit can manage an optional source modifier. A source modifier can provide a set
