...
/**
 * A text edit group combines a list of {@link TextEdit}s and a name into a single object. The name
 * must be a human readable string use to present the text edit group in the user interface.
 *
 * <p>Clients may extend this class to add extra information to a text edit group.
 */
public class TextEditGroup {
  ...
  /**
   * Returns <code>true</code> if the list of managed {@link TextEdit}s is empty; otherwise <code>
   * false
   * </code> is returned.
   *
  ...
  /**
   * Returns the text region covered by the edits managed via this edit group. If the group doesn't
   * manage any edits <code>null
   * </code> is returned.
   *
