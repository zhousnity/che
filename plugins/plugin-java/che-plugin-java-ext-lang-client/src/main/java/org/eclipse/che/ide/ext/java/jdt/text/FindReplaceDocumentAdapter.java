...
/**
 * Provides search and replace operations on {@link
 * org.eclipse.che.ide.legacy.client.api.text.eclipse.Document.text.IDocument}.
 *
 * <p>Replaces {@link
 * org.eclipse.che.ide.legacy.client.api.text.eclipse.Document.text.IDocument#search(int, String,
...
public class FindReplaceDocumentAdapter implements CharSequence {
  ...
  /**
   * Substitutes the previous match with the given text. Sends a <code>DocumentEvent</code> to all
