 ...
 *
 * <p>Clients may implement this interface or use the standard implementation {DefaultLineTracker}
 * or {ConfigurableLineTracker}.
 */
public interface LineTracker {
   ...
   * @throws BadLocationException if the line number is invalid in this tracker's line structure
   */
   ...
   * @throws BadLocationException if specified range is unknown to this tracker
   */
   ...
   * @throws BadLocationException if the line is unknown to this tracker
   */
   ...
   * @throws BadLocationException if line is unknown to this tracker
   */
   ...
   * @throws BadLocationException if the offset is invalid in this tracker
   */
   ...
   * @throws BadLocationException if offset is invalid in this tracker
   */
