...
public class Flags {
  ...
  /**
   * Returns whether the given integer does not include one of the <code>public</code>, <code>
   * private</code>, or <code>protected</code> flags.
   *
   * @param flags the flags
  ...
  /**
   * Returns whether the given integer has the <code>AccDefaultMethod</code> bit set. Note that this
   * flag represents the usage of the 'default' keyword on a method and should not be confused with
   * the 'package' access visibility (which used to be called 'default access').
   *
