...
/**
 * A move target edit denotes the target of a move operation. Move target edits are only valid
 * inside an edit tree if they have a corresponding source edit. Furthermore a target edit can't
 * can't be a direct or indirect child of its associated source edit. Violating one of two
 * requirements will result in a <code>
 * MalformedTreeException</code> when executing the edit tree.
 *
 * <p>Move target edits can't be used as a parent for other edits. Trying to add an edit to a move
 * target edit results in a <code>
...
public final class MoveTargetEdit extends TextEdit {
  ...
  protected void postProcessCopy(TextEditCopier copier) {
    if (fSource != null) {
      ...
      if (target != null && source != null) target.setSourceEdit(source);
    }
  }
