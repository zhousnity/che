 ...
 *
 * <p>Client should be started with {{@link #start()}} before performing communication with a
 * server. <br>
 * Server should be stopped with {{@link #stop()}} after finishing of communication with a server.
 *
...
public interface SshClient {
   ...
   *
   * @param commandLine command line to start over SSH
   ...
   *
   * @param sourcePath path on localhost that should be copied
   * @param targetPath path on remote host where file(s) from sourcePath should be copied
   * @throws MachineException
   */
