...
/**
 * Utilities class containing logic copied/pasted from Git extension that could/should be put into a
 * core VCS API.
 */
public class UpstreamUtils {
   ...
   */
  public static CommandLineResult executeCommandLine(
  ...
  public static CommandLineResult executeCommandLine(
    ...
    final CommandLineOutputProcessor stdOutConsumer =
        new CommandLineOutputProcessor(new ArrayList<String>());
    final CommandLineOutputProcessor stdErrConsumer =
        new CommandLineOutputProcessor(new ArrayList<String>());
    ...
    return new CommandLineResult(
        command, process.exitValue(), stdOutConsumer.getOutput(), stdErrConsumer.getOutput());
  }
}
