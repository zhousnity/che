...
public class SubversionProjectImporterTest {
   ...
   * org.eclipse.che.api.core.util.LineConsumerFactory)} invalid url.
   *
   * @throws Exception if anything goes wrong
   */
  @Test
