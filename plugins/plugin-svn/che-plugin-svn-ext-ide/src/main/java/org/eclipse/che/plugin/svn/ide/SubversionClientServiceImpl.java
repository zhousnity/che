...
public class SubversionClientServiceImpl implements SubversionClientService {
  ...
  @Inject
  public SubversionClientServiceImpl(
  ...
  @Override
  public Promise<CLIOutputResponse> add(
      Path project,
      Path[] path,
      String depth,
      boolean addIgnored,
    ...
    return asyncRequestFactory
        .createPostRequest(getBaseUrl() + "/add", request)
        .loader(loader)
  ...
  public Promise<CLIOutputResponse> revert(Path project, Path[] paths, String depth) {
    final RevertRequest request =
        dtoFactory
            .createDto(RevertRequest.class)
            .withProjectPath(project.toString())
            .withPaths(toList(paths))
            .withDepth(depth);
    return asyncRequestFactory
        .createPostRequest(getBaseUrl() + "/revert", request)
        .loader(loader)
        .send(dtoUnmarshallerFactory.newUnmarshaller(CLIOutputResponse.class));
  }

  @Override
  public Promise<CLIOutputResponse> copy(
      Path project, Path source, Path destination, String comment, Credentials credentials) {
    ...
    return asyncRequestFactory
        .createPostRequest(getBaseUrl() + "/copy", request)
        .loader(loader)
        .send(dtoUnmarshallerFactory.newUnmarshaller(CLIOutputResponse.class));
  }
  ...
  public Promise<CLIOutputResponse> remove(Path project, Path[] paths) {
    final RemoveRequest request =
        dtoFactory
            .createDto(RemoveRequest.class)
            .withPaths(toList(paths))
            .withProjectPath(project.toString());

    return asyncRequestFactory
        .createPostRequest(getBaseUrl() + "/remove", request)
        .loader(loader)
        .send(dtoUnmarshallerFactory.newUnmarshaller(CLIOutputResponse.class));
  }
  ...
  public Promise<CLIOutputResponse> merge(Path project, Path target, Path sourceUrl) {
    final MergeRequest request =
        dtoFactory
            .createDto(MergeRequest.class)
            .withProjectPath(project.toString())
            .withTarget(target.toString())
            .withSourceURL(sourceUrl.toString());
    return asyncRequestFactory
        .createPostRequest(getBaseUrl() + "/merge", request)
        .loader(loader)
        .send(dtoUnmarshallerFactory.newUnmarshaller(CLIOutputResponse.class));
  }
  ...
  public Promise<InfoResponse> info(
      Path project, String target, String revision, boolean children) {
  ...
  @Override
  public Promise<CLIOutputResponse> status(
      Path project,
      Path[] paths,
      String depth,
    ...
    return asyncRequestFactory
        .createPostRequest(getBaseUrl() + "/status", request)
        .loader(loader)
        .send(dtoUnmarshallerFactory.newUnmarshaller(CLIOutputResponse.class));
  }

  @Override
  public Promise<CLIOutputWithRevisionResponse> update(
      Path project,
      Path[] paths,
      String revision,
      String depth,
    ...
    return asyncRequestFactory
        .createPostRequest(getBaseUrl() + "/update", request)
        .loader(loader)
  ...
  public Promise<CLIOutputResponse> showLog(Path project, Path[] paths, String revision) {
    ...
    final ShowLogRequest request =
        dtoFactory
            .createDto(ShowLogRequest.class)
            .withProjectPath(project.toString())
            .withPaths(toList(paths))
            .withRevision(revision);
    return asyncRequestFactory
  ...
  @Override
  public Promise<CLIOutputResponse> lock(
      Path project, Path[] paths, boolean force, Credentials credentials) {
    final String url = getBaseUrl() + "/lock";
    final LockRequest request =
        dtoFactory
            .createDto(LockRequest.class)
            .withProjectPath(project.toString())
  ...
  @Override
  public Promise<CLIOutputResponse> unlock(
      Path project, Path[] paths, boolean force, Credentials credentials) {
  ...
  @Override
  public Promise<CLIOutputResponse> showDiff(
      Path project, Path[] paths, String revision, Credentials credentials) {
    final String url = getBaseUrl() + "/showdiff";
    final ShowDiffRequest request =
        dtoFactory
            .createDto(ShowDiffRequest.class)
            .withProjectPath(project.toString())
            .withPaths(toList(paths))
            .withRevision(revision);
    if (credentials != null) {
  ...
  public Promise<CLIOutputResponse> cleanup(Path project, Path[] paths) {
    ...
    final CleanupRequest request =
        dtoFactory
            .createDto(CleanupRequest.class)
            .withPaths(toList(paths))
            .withProjectPath(project.toString());
    return asyncRequestFactory
        .createPostRequest(url, request)
  ...
  @Override
  public Promise<CLIOutputResponse> move(
      Path project, Path source, Path destination, String comment, Credentials credentials) {
    ...
    return asyncRequestFactory
        .createPostRequest(getBaseUrl() + "/move", request)
        .loader(loader)
        .send(dtoUnmarshallerFactory.newUnmarshaller(CLIOutputResponse.class));
  }
  ...
  @Override
  public Promise<CLIOutputResponse> propertyDelete(
    ...
    return asyncRequestFactory
        .createPostRequest(getBaseUrl() + "/propdel", request)
        .loader(loader)
        .send(dtoUnmarshallerFactory.newUnmarshaller(CLIOutputResponse.class));
  }
  ...
  public Promise<GetRevisionsResponse> getRevisions(Path project, Path path, String revisionRange) {
    final GetRevisionsRequest request =
        dtoFactory
            .createDto(GetRevisionsRequest.class)
            .withProjectPath(project.toString())
            .withPath(path.toString())
            .withRevisionRange(revisionRange);
    return asyncRequestFactory
        .createPostRequest(getBaseUrl() + "/revisions", request)
        .loader(loader)
  ...
  public Promise<CLIOutputResponse> propertyGet(Path project, String propertyName, Path path) {
    final PropertyRequest request =
        dtoFactory
            .createDto(PropertyGetRequest.class)
            .withProjectPath(project.toString())
            .withName(propertyName)
            .withPath(path.toString());

    return asyncRequestFactory
        .createPostRequest(getBaseUrl() + "/propget", request)
        .loader(loader)
        .send(dtoUnmarshallerFactory.newUnmarshaller(CLIOutputResponse.class));
  }
  ...
  public Promise<CLIOutputResponse> propertyList(Path project, Path path) {
    final PropertyRequest request =
        dtoFactory
            .createDto(PropertyListRequest.class)
            .withProjectPath(project.toString())
            .withPath(path.toString());

    return asyncRequestFactory
        .createPostRequest(getBaseUrl() + "/proplist", request)
        .loader(loader)
        .send(dtoUnmarshallerFactory.newUnmarshaller(CLIOutputResponse.class));
  }

  @Override
  public Promise<CLIOutputResponse> list(
      Path project, String target, @Nullable Credentials credentials) {
    ListRequest request =
        dtoFactory
    ...
    return asyncRequestFactory
        .createPostRequest(getBaseUrl() + "/list", request)
        .loader(loader)
        .send(dtoUnmarshallerFactory.newUnmarshaller(CLIOutputResponse.class));
  }
  ...
  public Promise<CLIOutputResponse> listBranches(Path project, @Nullable Credentials credentials) {
    ListRequest request =
        dtoFactory.createDto(ListRequest.class).withProjectPath(project.toString());
    if (credentials != null) {
      request.setUsername(credentials.getUsername());
      request.setPassword(credentials.getPassword());
    }
    ...
    return asyncRequestFactory
        .createPostRequest(getBaseUrl() + "/branches", request)
        .loader(loader)
        .send(dtoUnmarshallerFactory.newUnmarshaller(CLIOutputResponse.class));
  }
  ...
  public Promise<CLIOutputResponse> listTags(Path project, @Nullable Credentials credentials) {
    ...
    return asyncRequestFactory
        .createPostRequest(getBaseUrl() + "/tags", request)
        .loader(loader)
        .send(dtoUnmarshallerFactory.newUnmarshaller(CLIOutputResponse.class));
  }
}
