 ...
 */
public class SubversionProjectImporterViewImpl extends Composite
    implements SubversionProjectImporterView {
  ...
  @UiField TextBox projectRelativePath;
  @UiField TextBox projectName;
  @UiField TextArea projectDescription;

  @Inject
  public SubversionProjectImporterViewImpl(
      SubversionExtensionResources resources, SubversionProjectImporterViewImplUiBinder uiBinder) {
