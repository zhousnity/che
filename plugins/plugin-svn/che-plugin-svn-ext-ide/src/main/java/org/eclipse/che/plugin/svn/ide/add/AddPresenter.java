...
public class AddPresenter extends SubversionActionPresenter {
  ...
  public void showAdd() {
    ...
    final StatusNotification notification =
        new StatusNotification(constants.addStarted(resources.length), PROGRESS, FLOAT_MODE);
    notificationManager.notify(notification);

    service
        .add(project.getLocation(), toRelative(project, resources), null, false, true, false, false)
        .then(
