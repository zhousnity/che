...
public class SubversionExtension {
  ...
  public SubversionExtension(
    ...
    final DefaultActionGroup addCommandGroup =
        new DefaultActionGroup(ADD_COMMAND_GROUP, false, actionManager);
    final DefaultActionGroup mainMenu =
        (DefaultActionGroup) actionManager.getAction(IdeActions.GROUP_MAIN_MENU);
    final DefaultActionGroup fileCommandGroup =
        new DefaultActionGroup(FILE_COMMAND_GROUP, false, actionManager);
    final DefaultActionGroup miscellaneousCommandGroup =
        new DefaultActionGroup(MISCELLANEOUS_COMMAND_GROUP, false, actionManager);
    final DefaultActionGroup remoteCommandGroup =
        new DefaultActionGroup(REMOTE_COMMAND_GROUP, false, actionManager);
    final DefaultActionGroup repositoryCommandGroup =
        new DefaultActionGroup(REPOSITORY_COMMAND_GROUP, false, actionManager);
    final DefaultActionGroup credentialsCommandGroup =
        new DefaultActionGroup(CREDENTIALS_COMMAND_GROUP, false, actionManager);
    final DefaultActionGroup svnMenu =
        new DefaultActionGroup(SVN_GROUP_MAIN_MENU, true, actionManager);
    ...
    DefaultActionGroup resourceOperationPartOfMainContextMenuGroup =
