 ...
 */
public interface SubversionProjectImporterView
    extends View<SubversionProjectImporterView.ActionDelegate> {
  ...
  public interface ActionDelegate {
    ...
    /**
     * Performs any actions appropriate in response to the user having changed the relative path in
     * the project.
     */
