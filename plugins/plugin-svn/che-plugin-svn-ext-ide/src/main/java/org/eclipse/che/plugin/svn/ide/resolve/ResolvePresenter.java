...
public class ResolvePresenter extends SubversionActionPresenter
    implements ResolveView.ActionDelegate {
  ...
  public void showConflictsDialog() {
    ...
    service
        .showConflicts(project.getLocation(), toRelative(project, resources))
        .then(
            new Operation<CLIOutputResponse>() {
              ...
              public void apply(CLIOutputResponse response) throws OperationException {
                ...
                if (conflictsList.isEmpty()) {
                  dialogFactory
                      .createMessageDialog(
                          constants.resolveNoConflictTitle(),
                          constants.resolveNoConflictContent(),
                          null)
                      .show();
