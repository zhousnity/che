...
public class CommitViewImpl extends Window implements CommitView {
  ...
  @UiField RadioButton commitAll;

  @UiField RadioButton commitSelection;

  @UiField CheckBox keepLocks;

  @UiField TextArea message;

  @UiField ScrollPanel changesWrapper;

  @UiField Label changedFilesCount;
  ...
  private static final String ADDED =
      org.eclipse.che.ide.api.theme.Style.getVcsConsoleStagedFilesColor();
  private static final String CONFLICTED =
      org.eclipse.che.ide.api.theme.Style.getVcsConsoleErrorColor();
  private static final String DELETED =
      org.eclipse.che.ide.api.theme.Style.getVcsConsoleErrorColor();
  private static final String MODIFIED =
      org.eclipse.che.ide.api.theme.Style.getVcsConsoleModifiedFilesColor();
  ...
  public void onMessageChanged(KeyUpEvent event) {
    ...
    alertMarker
        .getStyle()
        .setVisibility(
            !message.getText().isEmpty() ? Style.Visibility.HIDDEN : Style.Visibility.VISIBLE);
  }
