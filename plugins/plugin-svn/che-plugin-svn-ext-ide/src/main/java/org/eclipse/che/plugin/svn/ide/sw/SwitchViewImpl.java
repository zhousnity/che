...
public class SwitchViewImpl extends Window implements SwitchView {
  ...
  @UiField RadioButton switchToTrunk;
  @UiField RadioButton switchToBranch;
  @UiField RadioButton switchToTag;
  @UiField RadioButton switchToOtherLocation;
  @UiField ListBox switchToLocation;
  @UiField TextBox location;
  @UiField Button selectOtherLocation;

  @UiField CheckBox ignoreAncestry;
  @UiField CheckBox force;
  @UiField CheckBox ignoreExternals;

  @UiField RadioButton switchToHeadRevision;
  @UiField RadioButton switchToRevision;
  @UiField TextBox revision;

  @UiField ListBox depth;
  @UiField ListBox workingCopyDepth;
  @UiField ListBox accept;
