...
public class PropertyEditorViewImpl extends Window implements PropertyEditorView {
  ...
  @UiField RadioButton editProperty;

  @UiField RadioButton deleteProperty;

  @UiField TextArea propertyValue;

  @UiField ListBox depth;

  @UiField CheckBox force;

  @UiField TextArea propertyCurrentValue;
  ...
  public PropertyEditorViewImpl(
    ...
    final String[] props =
        new String[] {"svn:ignore", "svn:keywords", "svn:mime-type", "svn:mergeinfo"};
              ...
              public void onKeyUp(KeyUpEvent event) {
                ...
                if (keyCode >= KeyCodes.KEY_A && keyCode <= KeyCodes.KEY_Z
                  ...
                  if (!Strings.isNullOrEmpty(propertyListValue)
                    ...
                    btnOk.setEnabled(
                        editProperty.getValue() && !Strings.isNullOrEmpty(propertyValue.getText())
  ...
  public void onModeChanged(ClickEvent event) {
    if (editProperty.getValue()) {
      propertyValue.setEnabled(true);
      btnOk.setEnabled(
          !Strings.isNullOrEmpty(propertyList.getValue())
