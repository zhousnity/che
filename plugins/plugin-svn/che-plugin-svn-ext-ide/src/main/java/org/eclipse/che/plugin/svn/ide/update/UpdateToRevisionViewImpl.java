...
public class UpdateToRevisionViewImpl extends Window implements UpdateToRevisionView {
  ...
  private static UpdateToRevisionViewImplUiBinder ourUiBinder =
      GWT.create(UpdateToRevisionViewImplUiBinder.class);

  Button btnCancel;
  Button btnUpdate;
  @UiField ListBox depth;
  @UiField CheckBox ignoreExternals;
  @UiField RadioButton headRevision;
  @UiField RadioButton customRevision;
