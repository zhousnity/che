...
/**
 * Unit tests for {@link
 * org.eclipse.che.plugin.svn.ide.importer.SubversionProjectImporterPresenter}.
 */
@RunWith(MockitoJUnitRunner.class)
public class SubversionProjectImporterPresenterTest {
  @Mock private MutableProjectConfig dataObject;
  @Mock private MutableProjectConfig.MutableSourceStorage sourceStorage;
  @Mock private Map<String, String> parameters;
  @Mock private SubversionProjectImporterView view;
  @Mock private SubversionExtensionLocalizationConstants constants;
  @InjectMocks private SubversionProjectImporterPresenter presenter;
  ...
  /**
   * Test for {@link SubversionProjectImporterPresenter#onProjectNameChanged(String projectName)}
   * with an empty name.
   *
   * @throws Exception if anything goes wrong
   */
  ...
  /**
   * Test for {@link SubversionProjectImporterPresenter#onProjectUrlChanged(String projectUrl)} with
   * an non-URL value.
   *
   * @throws Exception if anything goes wrong
   */
  ...
  /**
   * Test for {@link SubversionProjectImporterPresenter#onProjectDescriptionChanged(String
   * projectDescription)}.
   *
   * @throws Exception if anything goes wrong
   */
