...
/**
 * Instructs Subversion to limit the scope of an operation to a particular tree depth. ARG is one of
 * empty (only the target itself), files (the target and any immediate file children thereof),
