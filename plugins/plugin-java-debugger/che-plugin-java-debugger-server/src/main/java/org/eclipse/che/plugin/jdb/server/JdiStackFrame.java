...
public interface JdiStackFrame {
   ...
   *     <ul>
   *       <li>static fields should go before non-static fields
   *       <li>fields of the same type should be ordered by name
   *     </ul>
   *
   ...
   * @throws DebuggerException if an error occurs
   * @throws DebuggerAbsentInformationException if an error occurs
   */
