...
public class GitImporterPagePresenter extends AbstractWizardPage<MutableProjectConfig>
    implements GitImporterPageView.ActionDelegate {
  ...
  @Inject
  public GitImporterPagePresenter(GitImporterPageView view, GitLocalizationConstant locale) {
    this.view = view;
