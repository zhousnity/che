 ...
 * different from the specified types in the set {@link MediaTypeFilter#excludedMediaTypes} Note: if
 * media type can not be detected a file will be not include in result as well.
 *
