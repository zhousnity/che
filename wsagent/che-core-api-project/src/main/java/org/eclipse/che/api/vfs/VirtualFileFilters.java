...
public class VirtualFileFilters {
  ...
  public static VirtualFileFilter createAndFilter(
      VirtualFileFilter filterOne, VirtualFileFilter filterTwo, VirtualFileFilter... filters) {
  ...
  public static VirtualFileFilter createOrFilter(
      VirtualFileFilter filterOne, VirtualFileFilter filterTwo, VirtualFileFilter... filters) {
    if (filters == null || filters.length == 0) {
      return new AndFilter(new VirtualFileFilter[] {filterOne, filterTwo});
    }
