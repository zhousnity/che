...
public class FolderEntry extends VirtualFileEntry {
  ...
  private static final VirtualFileFilter FILE_FOLDER_FILTER =
      file -> (file.isFile() || file.isFolder());
  ...
  /**
   * Get children of this folder. If current user doesn't have read access to some child they aren't
   * added in result list.
   *
  ...
  /**
   * Get child files of this folder. If current user doesn't have read access to some child they
   * aren't added in result list.
   *
   * @throws ServerException if an error occurs
   */
  ...
  /**
   * Gets child folders of this folder. If current user doesn't have read access to some child they
   * aren't added in result list.
   *
   * @throws ServerException if an error occurs
   */
  ...
  /**
   * Gets child folders and files of this folder. If current user doesn't have read access to some
   * child they aren't added in result list.
   *
   * @throws ServerException if an error occurs
   */
