...
/**
 * Writes object to stream and restores object from stream. Implementation has full control over
...
public interface DataSerializer<T> {
   ...
   *
   * @param output serialization stream
   * @param value instance for serialization
   ...
   *
   * @param input stream which contains serialized object
