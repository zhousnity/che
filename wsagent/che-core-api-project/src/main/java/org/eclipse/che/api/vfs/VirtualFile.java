...
public interface VirtualFile extends Comparable<VirtualFile> {
   ...
   *
   * @param filter virtual files filter
  ...
  /**
   * Gets child by relative path. If this VirtualFile is not folder this method returns {@code
   * null}.
   *
   * @param path child item path
   ...
   * @throws ForbiddenException if this item is not a file
   ...
   *       <li>size of file is too big and might not be retrieved as bytes
   *     </ul>
   *
   * @throws ServerException if other error occurs
   * @see #isFile()
   ...
   * @see #isFile()
   */
  VirtualFile updateContent(InputStream content, String lockToken)
   ...
   * @see #isFile()
   */
  VirtualFile updateContent(byte[] content, String lockToken)
      throws ForbiddenException, ServerException;
   ...
   * @see #isFile()
   */
  VirtualFile updateContent(String content, String lockToken)
      throws ForbiddenException, ServerException;
  ...
  /**
   * Gets properties of the file. Updating of map returned by this method does not effect state of
   * this file.
   *
   * @throws ServerException if an error occurs
   */
   ...
   *     <ul>
   *       <li>this item is locked file and {@code lockToken} is {@code null} or does not match
   *       <li>at least one property can't be updated cause to any constraint, e.g. property is read
   *           only
   *     </ul>
   *
   * @throws ServerException if other error occurs
   */
  VirtualFile updateProperties(Map<String, String> properties, String lockToken)
      throws ForbiddenException, ServerException;
   ...
   * @throws ServerException if other error occurs
   */
  VirtualFile updateProperties(Map<String, String> properties)
      throws ForbiddenException, ServerException;
   ...
   *     <ul>
   *       <li>this item is locked file and {@code lockToken} is {@code null} or does not match
   *       <li>property can't be updated cause to any constraint, e.g. property is read only
   *     </ul>
   *
   * @throws ServerException if other error occurs
   */
  VirtualFile setProperty(String name, String value, String lockToken)
      throws ForbiddenException, ServerException;
   ...
   *
   * @throws ForbiddenException if specified {@code parent} does not denote a folder
   * @throws ConflictException if {@code parent} already contains item with the same name as this
   *     virtual file has
   * @throws ServerException if other error occurs
   * @see #isFolder()
   */
  VirtualFile copyTo(VirtualFile parent)
   ...
   * @param name a new name for the moved source, can be left {@code null} or empty {@code String}
   *     for current source name
   * @param overwrite should the destination be overwritten, set to true to overwrite, false
   *     otherwise
   ...
   */
  @Beta
  VirtualFile copyTo(VirtualFile parent, String name, boolean overwrite)
      throws ForbiddenException, ConflictException, ServerException;
   ...
   * @throws ForbiddenException if any of following conditions are met:
   *     <ul>
   *       <li>specified {@code parent} does not denote a folder
   *       <li>this item is locked file
   *     </ul>
   *
   * @throws ConflictException if {@code parent} already contains item with the same name as this
   ...
   * @see #isFolder()
   */
  VirtualFile moveTo(VirtualFile parent)
      throws ForbiddenException, ConflictException, ServerException;
   ...
   * @param name a new name for the moved source, can be left {@code null} or empty {@code String}
   *     for current source name
   * @param overwrite should the destination be overwritten, set to {@code true} to overwrite,
   *     {@code false} otherwise
   * @param lockToken lock token. This parameter is required if the file is locked
   * @throws ForbiddenException if any of following conditions are met:
   *     <ul>
   *       <li>specified {@code parent} does not denote a folder
   *       <li>this item is locked file and {@code lockToken} is {@code null} or does not match
   ...
   * @param lockToken lock token. This parameter is required if the file is locked otherwise might
   *     be {@code null}
   * @throws ForbiddenException if this item is locked file and {@code lockToken} is {@code null} or
   *     does not match
   * @throws ConflictException if parent of this item already contains other item with {@code
   *     newName}
   * @throws ServerException if other error occurs
   */
  VirtualFile rename(String newName, String lockToken)
      throws ForbiddenException, ConflictException, ServerException;
   ...
   *
   * @param newName new name
   * @throws ForbiddenException if this item is locked file
   * @throws ConflictException if parent of this item already contains other item with {@code
   *     newName}
   * @throws ServerException if other error occurs
   */
   ...
   *     <ul>
   *       <li>this item is locked file and {@code lockToken} is {code null} or does not match
   *       <li>this item is folder that contains at least one locked file
   *     </ul>
   *
   * @throws ServerException if other error occurs
   */
   ...
   * @throws ForbiddenException if this item does not denote a folder
   * @throws ServerException if other error occurs
   */
   ...
   *     </ul>
   *
   * @throws ConflictException if {@code overwrite} is {@code false} and any item in zip archive
   *     causes name conflict
   * @throws ServerException if other error occurs
   */
  void unzip(InputStream zipped, boolean overwrite, int stripNumber)
      throws ForbiddenException, ConflictException, ServerException;
   ...
   *
   * @param timeout lock timeout in milliseconds, pass {@code 0} to create lock without timeout
   * @return lock token. User should pass this token when tries update, delete, rename or unlock
   *     locked file
   * @throws ForbiddenException if this VirtualFile does not denote a regular file
   * @throws ConflictException if this file already locked
   * @throws ServerException if other error occurs
   */
   ...
   * @throws ForbiddenException if {@code lockToken} is {@code null} or does not match
   * @throws ConflictException if this item is not locked
   * @throws ServerException if any other errors occur
   */
  VirtualFile unlock(String lockToken)
      throws ForbiddenException, ConflictException, ServerException;
   ...
   * @throws ForbiddenException if this VirtualFile does not denote a folder
   * @throws ConflictException if parent already contains item with specified {@code name}
   * @throws ServerException if other error occurs
   */
   ...
   *
   * @param name name. If name is string separated by '/' all nonexistent parent folders must be
   *     created.
   * @return newly create VirtualFile that denotes folder
   * @throws ForbiddenException if this VirtualFile does not denote a folder
   * @throws ConflictException if item with specified {@code name} already exists
   * @throws ServerException if other error occurs
   */
  VirtualFile createFolder(String name)
      throws ForbiddenException, ConflictException, ServerException;
  ...
  /**
   * Accepts an {@code VirtualFileVisitor}. Calls the {@link VirtualFileVisitor#visit(VirtualFile)}
   * method.
   *
   * @param visitor VirtualFileVisitor to be accepted
   * @throws ServerException if an error occurs
   */
  void accept(VirtualFileVisitor visitor) throws ServerException;

  /**
   * Traverses recursively all files in current folder and count md5sum for each file. Method
   * returns {@code Pair&lt;String, String&gt;} for each file, all folders are omitted. Each {@code
   * Pair} contains following structure:
   *
   * <pre>
   ...
   * </pre>
   *
   * If this VirtualFile is not a folder this method returns empty list. Note: any order of items in
