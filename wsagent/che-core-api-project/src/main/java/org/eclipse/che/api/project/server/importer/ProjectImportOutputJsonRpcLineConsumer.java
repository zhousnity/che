...
/**
 * Importer output line consumer that perform broadcasting consumed output through the json rpc
 * protocol to the specific method.
 *
...
public class ProjectImportOutputJsonRpcLineConsumer extends BaseProjectImportOutputLineConsumer {
  ...
  public ProjectImportOutputJsonRpcLineConsumer(
      String projectName,
