...
public class LocalVirtualFile implements VirtualFile {
  ...
  @Override
  public VirtualFile updateProperties(Map<String, String> properties, String lockToken)
      throws ForbiddenException, ServerException {
  ...
  @Override
  public LocalVirtualFile copyTo(VirtualFile parent)
  ...
  @Override
  public VirtualFile unlock(String lockToken)
      throws ForbiddenException, ConflictException, ServerException {
  ...
  public boolean equals(Object o) {
    ...
    if ((o instanceof LocalVirtualFile)) {
      ...
      return Objects.equals(path, other.path) && Objects.equals(fileSystem, other.fileSystem);
    }
    return false;
  }
