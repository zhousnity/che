...
/**
 * Traverses recursively all files in folder given in constructor and calculates hash sum for each
 * file. Algorithm specified by {@code hashFunction} is used for calculating hash sum.
 */
