...
public class LocalVirtualFileTest {
  ...
  public void renamesFolder() throws Exception {
    ...
    assertionHelper.assertThatMetadataIoFileHasContent(
        renamed.getPath(), serializeVirtualFileMetadata(ImmutableMap.of("property1", "value1")));
    assertionHelper.assertThatMetadataIoFileHasContent(
        newFilePath, serializeVirtualFileMetadata(ImmutableMap.of("property2", "value2")));
  ...
  public void failsDeleteLockedFileWithoutLockToken() throws Exception {
    ...
    try {
      ...
      assertionHelper.assertThatIoFileHasContent(filePath, DEFAULT_CONTENT_BYTES);
      assertionHelper.assertThatMetadataIoFileHasContent(
          file.getPath(), serializeVirtualFileMetadata(ImmutableMap.of("property1", "value1")));
      assertionHelper.assertThatLockIoFileExists(filePath);
    }
  }
