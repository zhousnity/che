...
public class ProjectManagerReadTest extends WsAgentTestBase {
  ...
  public void testParentProject() throws Exception {
    ...
    assertEquals(
        "/normal/module", projectRegistry.getParentProject("/normal/module/some/path").getPath());
  ...
  public void testIfConstantAttrIsAccessible() throws Exception {
    ...
    assertEquals(
        "my constant", pm.getProject("/normal").getAttributeEntries().get("const1").getString());
  }
}
