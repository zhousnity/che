...
public class ProjectManagerWriteTest extends WsAgentTestBase {
  ...
  public void testCreateBatchProjectsByImportingSourceCode() throws Exception {
    ...
    final SourceStorageDto source1 =
        DtoFactory.newDto(SourceStorageDto.class)
            .withLocation("someLocation")
            .withType(importType1);
    final NewProjectConfigDto config1 =
        createProjectConfigObject("testProject1", projectPath1, BaseProjectType.ID, source1);

    final SourceStorageDto source2 =
        DtoFactory.newDto(SourceStorageDto.class)
            .withLocation("someLocation")
            .withType(importType2);
    final NewProjectConfigDto config2 =
        createProjectConfigObject("testProject2", projectPath2, BaseProjectType.ID, source2);
  ...
  public void testCreateProjectWhenSourceCodeIsNotReachable() throws Exception {
    ...
    final SourceStorageDto source =
        DtoFactory.newDto(SourceStorageDto.class)
            .withLocation("someLocation")
            .withType("importType");
    final NewProjectConfigDto config =
        createProjectConfigObject("testProject1", projectPath, BaseProjectType.ID, source);
  ...
  public void shouldRollbackCreatingBatchProjects() throws Exception {
    ...
    final SourceStorageDto source =
        DtoFactory.newDto(SourceStorageDto.class)
            .withLocation("someLocation")
            .withType("importType");
    final NewProjectConfigDto config3 =
    ...
    try {
      pm.createBatchProjects(configs, false, new ProjectOutputLineConsumerFactory("ws", 300));
      fail(
          "We should rollback operation of creating batch projects when we could not get source code for at least one project");
    } catch (Exception e) {
      assertEquals(0, projectRegistry.getProjects().size());
  ...
  public void testCreateBatchProjectsWithInnerProject() throws Exception {
    ...
    final String[] paths1 = {"folder1/", "folder1/file1.txt"};
    final String[] paths2 = {
      "innerProject/", "innerProject/folder2/", "innerProject/folder2/file2.txt"
    };
    ...
    SourceStorageDto source =
        DtoFactory.newDto(SourceStorageDto.class).withLocation("someLocation").withType(importType);
    NewProjectConfigDto config1 =
        createProjectConfigObject("testProject1", rootProjectPath, BaseProjectType.ID, source);
    NewProjectConfigDto config2 =
        createProjectConfigObject("innerProject", innerProjectPath, innerProjectType, null);
  ...
  @Test
  public void testCreateBatchProjectsWithInnerProjectWhenInnerProjectContainsSource()
      throws Exception {
    ...
    final SourceStorageDto source1 =
        DtoFactory.newDto(SourceStorageDto.class)
            .withLocation("someLocation")
            .withType(rootImportType);
    final NewProjectConfigDto config1 =
        createProjectConfigObject("testProject1", rootProjectPath, BaseProjectType.ID, source1);

    final SourceStorageDto source2 =
        DtoFactory.newDto(SourceStorageDto.class)
            .withLocation("someLocation")
            .withType(innerImportType);
    final NewProjectConfigDto config2 =
        createProjectConfigObject("testProject2", innerProjectPath, innerProjectType, source2);
    config2.setAttributes(attributes);
  ...
  @Test
  public void testCreateBatchProjectsWithMixInnerProjects()
      throws Exception { // Projects should be sorted by path before creating
    ...
    for (String path : projectsPaths) {
      configs.add(
          createProjectConfigObject(
              path.substring(path.length() - 1, path.length()), path, BaseProjectType.ID, null));
    }
  ...
  @Test
  public void shouldRewriteProjectAtCreatingBatchProjectsWhenProjectAlreadyExist()
      throws Exception {
    final String projectPath = "/testProject";
    final String importType1 = "importType1";
    final String importType2 = "importType2";
    ...
    final SourceStorageDto source1 =
        DtoFactory.newDto(SourceStorageDto.class)
            ...
            .withType(importType1);
    final NewProjectConfigDto config1 =
        createProjectConfigObject("testProject1", projectPath, "blank", source1);
    ...
    final SourceStorageDto source2 =
        DtoFactory.newDto(SourceStorageDto.class)
            ...
            .withType(importType2);
    final NewProjectConfigDto config2 =
        createProjectConfigObject("testProject2", projectPath, "blank", source2);
  ...
  public void shouldSetBlankTypeAtCreatingBatchProjectsWhenConfigContainsUnregisteredProjectType()
    ...
    final NewProjectConfig config =
        createProjectConfigObject("projectName", projectPath, projectType, null);
  ...
  public void testSamePathProjectCreateFailed() throws Exception {
    ...
    ProjectConfig pc =
        new NewProjectConfigImpl(
            "/testSamePathProjectCreateFailed", "blank", null, "name", "descr", null, null, null);
  ...
  public void testConflictAttributesProjectCreateFailed() throws Exception {
    ...
    ProjectConfig pc =
        new NewProjectConfigImpl(path, projectTypeId, ms, "name", "descr", null, null, null);
    pm.createProject(pc, null);
  ...
  public void testInvalidConfigProjectCreateFailed() throws Exception {
    ...
    ProjectConfig pc =
        new NewProjectConfigImpl(null, "pt2", null, "name", "descr", null, null, null);
  ...
  public void testCreateInnerProject() throws Exception {
    ProjectConfig pc =
        new NewProjectConfigImpl(
            "/testCreateInnerProject", BaseProjectType.ID, null, "name", "descr", null, null, null);
    pm.createProject(pc, null);

    pc =
        new NewProjectConfigImpl(
            "/testCreateInnerProject/inner",
            BaseProjectType.ID,
            null,
            "name",
            "descr",
    ...
    pc =
        new NewProjectConfigImpl(
            "/nothing/inner", BaseProjectType.ID, null, "name", "descr", null, null, null);
  ...
  public void testUpdateProjectWithPersistedAttributes() throws Exception {
    ...
    ProjectConfig pc =
        new NewProjectConfigImpl(
            "/testUpdateProject", BaseProjectType.ID, null, "name", "descr", null, null, null);
    ...
    ProjectConfig pc1 =
        new NewProjectConfigImpl(
            "/testUpdateProject", "pt2", null, "updatedName", "descr", attributes, null, null);
  ...
  public void testUpdateProjectWithProvidedAttributes() throws Exception {
    ...
    ProjectConfig pc =
        new NewProjectConfigImpl(
            "/testUpdateProject", "pt2", null, "name", "descr", attributes, null, null);
    pm.createProject(pc, null);

    pc =
        new NewProjectConfigImpl(
            "/testUpdateProject", "pt3", null, "updatedName", "descr", attributes, null, null);
  ...
  public void testInvalidUpdateConfig() throws Exception {
    ProjectConfig pc =
        new NewProjectConfigImpl(null, BaseProjectType.ID, null, "name", "descr", null, null, null);
    ...
    pc =
        new NewProjectConfigImpl(
            "/nothing", BaseProjectType.ID, null, "name", "descr", null, null, null);
    try {
      pm.updateProject(pc);
  ...
  public void testDeleteProject() throws Exception {
    ...
    ProjectConfig pc =
        new NewProjectConfigImpl(
            "/testDeleteProject", BaseProjectType.ID, null, "name", "descr", null, null, null);
    pm.createProject(pc, null);
    pc =
        new NewProjectConfigImpl(
            "/testDeleteProject/inner",
            BaseProjectType.ID,
            null,
            "name",
            "descr",
  ...
  public void testImportProject() throws Exception {
    ...
    pm.importProject(
        ...
        sourceConfig,
        false,
        () -> new ProjectImportOutputWSLineConsumer("BATCH", 300));
    ...
    assertEquals(
        fileContent,
        project.getBaseFolder().getChild("file1").getVirtualFile().getContentAsString());
  }
  ...
  public void testRemoveFolderForSourcesWhenImportingProjectIsFailed() throws Exception {
    ...
    try {
      pm.importProject(
          ...
          sourceConfig,
          false,
          () -> new ProjectImportOutputWSLineConsumer("testImportProject", 300));
    } catch (Exception e) {
    }

    boolean projectFolderExist =
        vfsProvider.getVirtualFileSystem().getRoot().hasChild(Path.of(projectPath));
  ...
  public void testImportProjectWithoutImporterFailed() throws Exception {
    ...
    try {
      pm.importProject(
          ...
          () -> new ProjectImportOutputWSLineConsumer("testImportProject", 300));
      fail(
          "NotFoundException: Unable import sources project from 'null'. Sources type 'nothing' is not supported.");
    } catch (NotFoundException e) {
    }
  }
  ...
  public void testProvidedAttributesNotSerialized() throws Exception {
    ...
    ProjectConfig pc =
        new NewProjectConfigImpl(
            "/testProvidedAttributesNotSerialized",
            "pt3",
            null,
            "name",
            "descr",
  ...
  public void testSettableValueProvider() throws Exception {
    assertTrue(
        ((Variable) projectTypeRegistry.getProjectType("settableVPPT").getAttribute("my"))
            .isValueProvided());

    ProjectConfig pc =
        new NewProjectConfigImpl(
            "/testSettableValueProvider",
            "settableVPPT",
            null,
            "",
            "",
    ...
    pc =
        new NewProjectConfigImpl(
            "/testSettableValueProvider", "settableVPPT", null, "", "", attributes, null, null);
  ...
  private void checkChildrenFor(FolderEntry projectFolder, List<String> children)
  ...
  private NewProjectConfigDto createProjectConfigObject(
      String projectName, String projectPath, String projectType, SourceStorageDto sourceStorage) {
  ...
  class SrcGenerator implements CreateProjectHandler {
    ...
    public void onCreateProject(
      ...
      FolderEntry baseFolder =
          new FolderEntry(
              vfsProvider.getVirtualFileSystem().getRoot().createFolder(projectPath.toString()));
