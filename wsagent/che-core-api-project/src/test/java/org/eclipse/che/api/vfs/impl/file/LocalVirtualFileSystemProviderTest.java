...
public class LocalVirtualFileSystemProviderTest {
  ...
  public void setUp() throws Exception {
    ...
    fileSystemProvider =
        new LocalVirtualFileSystemProvider(fsRootDirectory, mock(SearcherProvider.class));
  }
  ...
  @Test
  public void doesNotCreateVirtualFileSystemWhenItIsNotCreatedYetAndCreationIsNotRequested()
      throws Exception {
  ...
  private AtomicReference<VirtualFileSystem> getFileSystemReference() throws Exception {
    Field fileSystemReferenceField =
        AbstractVirtualFileSystemProvider.class.getDeclaredField("fileSystemReference");
