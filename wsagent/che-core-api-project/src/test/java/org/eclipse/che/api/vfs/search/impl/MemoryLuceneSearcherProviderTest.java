...
public class MemoryLuceneSearcherProviderTest {
  ...
  public void setUp() throws Exception {
    memoryLuceneSearcherProvider =
        new MemoryLuceneSearcherProvider(newHashSet(mock(VirtualFileFilter.class)));
  }

  @Test
  public void doesNotCreateSearcherWhenItIsNotCreatedYetAndCreationIsNotRequested()
      throws Exception {
