...
public class TestingService {
  ...
  public List<TestResultDto> getTestResults(@Context UriInfo uriInfo) throws Exception {
    ...
    getTestRunner(testFramework);
    List<TestResultDto> result =
        frameworkRegistry.getTestRunner(testFramework).getTestResults(testResultsPath);
    return result;
  }
  ...
  private WebApplicationException translateException(Throwable e) {
    ...
    return new WebApplicationException(
        Response.status(Response.Status.INTERNAL_SERVER_ERROR)
            .entity("An unexpected error occured during test execution: " + e.toString())
            .build());
  }
}
