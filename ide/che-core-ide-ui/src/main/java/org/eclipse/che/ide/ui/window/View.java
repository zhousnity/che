...
/**
 * The view that renders the {@link Window}. The View consists of a glass panel that fades out the
 * background, and a DOM structure that positions the contents in the exact center of the screen.
 */
class View extends Composite {
  ...
  @UiField FlowPanel contentContainer;
   ...
   * value of {@link Window.Css#animationDuration()}.
   */
   ...
   * set before calling {@link #setShowing(boolean)}.
   *
