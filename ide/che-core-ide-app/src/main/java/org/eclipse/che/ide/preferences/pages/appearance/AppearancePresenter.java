...
public class AppearancePresenter extends AbstractPreferencePagePresenter implements AppearanceView.ActionDelegate {
    ...
    public static final String PREF_SHOW_MAVEN_MODULE = "ide.project.explorer.show.maven.module";
    ...
    public AppearancePresenter(AppearanceView view,
        ...
        showMavenModule = Boolean.valueOf(preferencesManager.getValue(PREF_SHOW_MAVEN_MODULE));
    }
    ...
    public void go(AcceptsOneWidget container) {
        ...
        view.setSelectedShowMavenModuleCheckBox(Boolean.valueOf(preferencesManager.getValue(PREF_SHOW_MAVEN_MODULE)));
    }
    ...
    @Override
    public void showMavenModuleCheckBoxValueChanged(boolean showMavenModule) {
        this.showMavenModule = showMavenModule;
        dirty = showMavenModule != Boolean.valueOf(preferencesManager.getValue(PREF_SHOW_MAVEN_MODULE));
        delegate.onDirtyChanged();
    }
    ...
    public void storeChanges() {
        ...
        preferencesManager.setValue(PREF_SHOW_MAVEN_MODULE, String.valueOf(showMavenModule));
