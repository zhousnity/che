...
public class AppearanceViewImpl implements AppearanceView {
    ...
    @Override
    public void setSelectedShowMavenModuleCheckBox(boolean selected) {
        showMavenModule.setValue(selected);
    }
    ...
    @UiHandler("showMavenModule")
    void handleSHowMavenModuleCheckBox(ClickEvent event) {
        delegate.showMavenModuleCheckBoxValueChanged(showMavenModule.getValue());
    }
