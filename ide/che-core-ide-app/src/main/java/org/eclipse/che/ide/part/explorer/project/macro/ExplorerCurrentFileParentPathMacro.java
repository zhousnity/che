...
/**
 * Provider which is responsible for retrieving the resource's parent path from the project
 * explorer.
 *
 * <p>Macro provided: <code>${explorer.current.file.parent.path}</code>
 *
...
public class ExplorerCurrentFileParentPathMacro implements Macro {
  ...
  private Function<Resource, String> resourceToAbsoluteParentPathFun =
  ...
  @Inject
  public ExplorerCurrentFileParentPathMacro(
  ...
  public Promise<String> expand() {
    ...
    final String commaSeparated =
        Joiner.on(", ").join(transform(resources, resourceToAbsoluteParentPathFun));
