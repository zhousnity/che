...
class StartWorkspaceViewImpl extends Window implements StartWorkspaceView {
  ...
  private static final StartWorkspaceViewImplUiBinder UI_BINDER =
      GWT.create(StartWorkspaceViewImplUiBinder.class);
  ...
  @UiField TextBox workspaces;

  @Inject
  public StartWorkspaceViewImpl(
      CoreLocalizationConstant locale,
      org.eclipse.che.ide.Resources resources,
      FlowPanel workspacesPanel) {
    this.locale = locale;
