...
interface CreateWorkspaceView extends View<CreateWorkspaceView.ActionDelegate> {
   ...
   *
   * @param recipes recipes which will be shown
   */
   ...
   *
   * @param visible <code>true</code> error message is visible, <code>false</code> error message is
   *     not visible
   */
   ...
   *
   * @param visible <code>true</code> button is enable, <code>false</code> button is not enable
   */
