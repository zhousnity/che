...
/**
 * Provider which is responsible for retrieving the resource name without extension from the project
 * explorer.
 *
 * <p>Macro provided: <code>${explorer.current.file.basename}</code>
 *
...
@Beta
@Singleton
public class ExplorerCurrentFileBaseNameMacro implements Macro {

  public static final String KEY = "${explorer.current.file.basename}";
  ...
  private Function<Resource, String> resourceToNameFun =
      new Function<Resource, String>() {
        ...
        public String apply(@Nullable Resource input) {
          ...
          if (input.isFile()) {
            return input.asFile().getNameWithoutExtension();
          }
  ...
  @Inject
  public ExplorerCurrentFileBaseNameMacro(
  ...
  public String getDescription() {
    return localizationConstants.macroExplorerCurrentFileBaseNameDescription();
  }
