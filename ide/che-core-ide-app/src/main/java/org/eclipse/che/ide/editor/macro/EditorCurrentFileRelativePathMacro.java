...
/**
 * Provider which is responsible for retrieving the relative to the {@code /projects} folder file
 * path from the opened editor.
 *
 * <p>Macro provided: <code>${editor.current.file.relpath}</code>
 *
...
public class EditorCurrentFileRelativePathMacro extends AbstractEditorMacro {
  ...
  @Inject
  public EditorCurrentFileRelativePathMacro(
