...
public class UserProfileServiceClientImpl implements UserProfileServiceClient {
  ...
  @Inject
  protected UserProfileServiceClientImpl(
  ...
  public void updateCurrentProfile(
      @NotNull Map<String, String> updates, AsyncRequestCallback<ProfileDto> callback) {
    asyncRequestFactory
        .createPostRequest(PROFILE, null)
        .header(ACCEPT, APPLICATION_JSON)
  ...
  public void updateProfile(
      @NotNull String id, Map<String, String> updates, AsyncRequestCallback<ProfileDto> callback) {
    String requestUrl = PROFILE + id;
