...
/**
 * Provider which is responsible for retrieving the resource relative path from the project
 * explorer.
 *
 * <p>Macro provided: <code>${explorer.current.file.relpath}</code>
 *
...
public class ExplorerCurrentFileRelativePathMacro implements Macro {
  ...
  private Function<Resource, String> resourceToPathFun =
  ...
  @Inject
  public ExplorerCurrentFileRelativePathMacro(
