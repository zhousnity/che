...
/**
 * Provider which is responsible for retrieving the resource's project type from the project
 * explorer.
 *
 * <p>Macro provided: <code>${explorer.current.project.type}</code>
 *
...
public class ExplorerCurrentProjectTypeMacro implements Macro {
  ...
  @Inject
  public ExplorerCurrentProjectTypeMacro(
