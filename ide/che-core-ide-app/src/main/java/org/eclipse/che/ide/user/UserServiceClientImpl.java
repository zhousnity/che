...
public class UserServiceClientImpl implements UserServiceClient {
  ...
  @Inject
  protected UserServiceClientImpl(
  ...
  public void createUser(
      @NotNull String token, boolean isTemporary, AsyncRequestCallback<UserDto> callback) {
    ...
    asyncRequestFactory
        .createPostRequest(requestUrl.toString(), null)
  ...
  public void removeUser(@NotNull String id, AsyncRequestCallback<Void> callback) {
    ...
    asyncRequestFactory
        .createRequest(DELETE, requestUrl, null, false)
