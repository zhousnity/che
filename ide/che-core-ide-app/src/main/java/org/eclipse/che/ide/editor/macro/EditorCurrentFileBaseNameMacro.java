...
/**
 * Provider which is responsible for retrieving the file name without extension from the opened
 * editor.
 *
 * <p>Macro provided: <code>${editor.current.file.basename}</code>
 *
...
public class EditorCurrentFileBaseNameMacro extends AbstractEditorMacro {
  ...
  @Inject
  public EditorCurrentFileBaseNameMacro(
