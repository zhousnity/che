...
public class FullTextSearchPresenterTest {
  ...
  @Mock private Promise<Resource[]> searchResultPromise;
  @Captor private ArgumentCaptor<Operation<Resource[]>> searchResultCaptor;
  @Captor private ArgumentCaptor<Operation<PromiseError>> operationErrorCapture;
  @Captor private ArgumentCaptor<Operation<Resource[]>> operationSuccessCapture;
