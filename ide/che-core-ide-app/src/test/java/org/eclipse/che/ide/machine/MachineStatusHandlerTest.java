...
public class MachineStatusHandlerTest {
  ...
  @Mock private MachineConfigDto machineConfigDto;
  @Mock private MachineStatusChangedEvent machineStatusChangedEvent;
  @Mock private Promise<WorkspaceDto> workspacePromise;
  @Mock private WorkspaceDto workspace;
  @Mock private WorkspaceRuntimeDto workspaceRuntime;

  @Mock(answer = RETURNS_DEEP_STUBS)
  private RequestTransmitter transmitter;

  @Captor private ArgumentCaptor<Operation<WorkspaceDto>> workspaceCaptor;
  ...
  public void setUp() {
    statusNotifier =
        new MachineStatusHandler(
            eventBus, appContext, workspaceServiceClient, notificationManager, locale, transmitter);
