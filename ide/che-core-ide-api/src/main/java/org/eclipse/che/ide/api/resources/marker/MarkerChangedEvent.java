...
/**
 * Marker created event. This event fires when marker has been created. Created, means that marker
 * has bound to the resource.
 *
...
public class MarkerChangedEvent extends GwtEvent<MarkerChangedEvent.MarkerChangedHandler> {
   ...
   *
   * <p>Third party components may implement this interface to handle marker creation event.
   */
  public interface MarkerChangedHandler extends EventHandler {
     ...
     *
     * @param event instance of {@link MarkerChangedEvent}
