...
public class ProjectTypeServiceClientImpl implements ProjectTypeServiceClient {
  ...
  @Inject
  protected ProjectTypeServiceClientImpl(
  ...
  public Promise<List<ProjectTypeDto>> getProjectTypes(@NotNull final DevMachine devMachine) {
    return fetchProjectTypes(devMachine)
        .then(
            new Function<List<ProjectTypeDto>, List<ProjectTypeDto>>() {
              @Override
  ...
  @Override
  public Promise<ProjectTypeDto> getProjectType(
      @NotNull DevMachine devMachine, @NotNull String id) {
