 ...
 * add new perspective. Provides methods to define type and view representation of perspective.
 *
...
public interface Perspective extends StateComponent {
   ...
   * Removes part.
   *
   * @param part part which will be removed
   */
   ...
   *
   * @param part part which wil be focused
   */
   ...
   * Hides current part.
   *
   * @param part part which need hide
   */
   ...
   *
   * @param part part which need open
   ...
   *
   * @param part part which will be opened
   * @param type part stack type to find it among active part stacks
   * @param constraint constraints with which need open part
   */
  void addPart(
   ...
   *
   * @param type type for which need get part stack
