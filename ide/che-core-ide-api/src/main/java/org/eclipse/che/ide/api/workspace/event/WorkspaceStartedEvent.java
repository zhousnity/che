...
/**
 * The class contains information about started workspace and provides ability to handle events when
 * workspace starts.
 *
...
public class WorkspaceStartedEvent extends GwtEvent<WorkspaceStartedEvent.Handler> {
  ...
  public interface Handler extends EventHandler {
     ...
     *
     * @param event contains information about started workspace
     */
