...
public interface WorkspaceServiceClient {
   ...
   *
   * @param skip the number of the items to skip
   * @param limit the limit of the items in the response, default is 30
   ...
   * @param update the new configuration to update the workspace
   * @return a promise that resolves to the {@link WorkspaceDto}, or rejects with an error
   ...
   *
   * @param wsId workspace ID
   * @return a promise that will resolve when the workspace has been removed, or rejects with an
   *     error
   ...
   *
   * @param cfg the configuration to start the workspace from
   * @param accountId the account id related to this operation
   * @return a promise that resolves to the {@link WorkspaceDto}, or rejects with an error
   * @see WorkspaceService#startFromConfig(WorkspaceConfigDto, Boolean, String)
   */
  Promise<WorkspaceDto> startFromConfig(
      WorkspaceConfigDto cfg, boolean isTemporary, String accountId);
   ...
   *
   * @param wsId workspace ID
   * @param envName the name of the environment to add
   ...
   *
   * @param wsId workspace ID
   * @param environmentUpdate the environment to update
   * @return a promise that resolves to the {@link WorkspaceDto}, or rejects with an error
   * @see WorkspaceService#updateEnvironment(String, String, EnvironmentDto)
   */
  Promise<WorkspaceDto> updateEnvironment(
   ...
   *
   * @param wsId workspace ID
   * @param newEnv the new project configuration
   * @return a promise that resolves to the {@link WorkspaceDto}, or rejects with an error
   ...
   *
   * @param wsId workspace ID
   * @param machineConfig the new machine configuration
   ...
   *
   * @param workspaceId workspace ID
   * @return a promise that will resolve when the snapshot has been created, or rejects with an
   *     error
