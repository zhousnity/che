...
public abstract class Service {
  ...
  /**
   * Generates link header value based on given {@code page} and uri returned by {@code
  ...
  /**
   * This method is the same to the {@link #createLinkHeader(Page, String, Map, Object...)} except
   * of receiving query parameters.
   */
