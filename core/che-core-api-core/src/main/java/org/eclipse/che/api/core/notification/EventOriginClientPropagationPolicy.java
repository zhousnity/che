...
public class EventOriginClientPropagationPolicy implements ClientEventPropagationPolicy {
  ...
  private static final Logger LOG =
      LoggerFactory.getLogger(EventOriginClientPropagationPolicy.class);
