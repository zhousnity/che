...
/**
 * Encrypts password using <a
 * href="https://en.wikipedia.org/wiki/PBKDF2">Password-based-Key-Derivative-Function</a> with
 * <b>SHA512</b> as pseudorandom function. See <a
 * href="https://www.ietf.org/rfc/rfc2898.txt">rfc2898</a>.
 *
...
public class PBKDF2PasswordEncryptor implements PasswordEncryptor {
  ...
  private static final Pattern PWD_REGEX =
      Pattern.compile("(?<pwdHash>\\w+):(?<saltHash>\\w+):(?<iterations>[0-9]+)");
