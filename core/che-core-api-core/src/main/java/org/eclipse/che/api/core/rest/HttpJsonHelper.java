...
public class HttpJsonHelper {
  ...
  public static <DTO> DTO request(
      Class<DTO> dtoInterface, int timeout, Link link, Pair<String, ?>... parameters)
      throws IOException, ServerException, UnauthorizedException, ForbiddenException,
          NotFoundException, ConflictException {
  ...
  public static <DTO> List<DTO> requestArray(
      Class<DTO> dtoInterface, Link link, Pair<String, ?>... parameters)
      throws IOException, ServerException, UnauthorizedException, ForbiddenException,
          NotFoundException, ConflictException {
   ...
   * <p>
   *
   * <p>type of expected response. If server returns some content we try parse it and restore object
   * of the specified type from it. Specified interface must be annotated with &#064DTO.
   *
   * @param url URL to send request
   * @param method HTTP method
   * @param body body of request. Object must implements DTO interface (interface must be annotated
   *     with &#064DTO).
   ...
   * @throws ServerException if server returns error response in supported JSON format, see {@link
   ...
   *
   * @param dtoInterface type of expected response. If server returns some content we try parse it
   *     and restore object of the specified type from it. Specified interface must be annotated
   *     with &#064DTO.
   * @param url URL to send request
   * @param parameters additional query parameters.
   * @return instance of {@code dtoInterface} which represents JSON response from the server
  ...
  public static <DTO> DTO get(
      Class<DTO> dtoInterface, int timeout, String url, Pair<String, ?>... parameters)
      throws IOException, ServerException, NotFoundException, ForbiddenException,
          UnauthorizedException, ConflictException {
   ...
   * @see org.eclipse.che.dto.shared.DTO
   */
  public static <DTO> DTO post(
      Class<DTO> dtoInterface, String url, Object body, Pair<String, ?>... parameters)
      throws IOException, ServerException, NotFoundException, ForbiddenException,
          UnauthorizedException, ConflictException {
  ...
  public static <DTO> DTO post(
      Class<DTO> dtoInterface, int timeout, String url, Object body, Pair<String, ?>... parameters)
      throws IOException, ServerException, NotFoundException, ForbiddenException,
          UnauthorizedException, ConflictException {
   ...
   * @see org.eclipse.che.dto.shared.DTO
   */
  public static <DTO> DTO options(
      Class<DTO> dtoInterface, String url, Pair<String, ?>... parameters)
      throws IOException, ServerException, NotFoundException, ForbiddenException,
          UnauthorizedException, ConflictException {
  ...
  public static class HttpJsonHelperImpl {
    ...
    public void request(String url, String method, Object body, Pair<String, ?>... parameters)
        throws IOException, ServerException, UnauthorizedException, ForbiddenException,
            NotFoundException, ConflictException {
      request(null, -1, url, method, body, parameters);
    }

    public <DTO> DTO request(
        Class<DTO> dtoInterface,
        String url,
        String method,
        Object body,
    ...
    public <DTO> List<DTO> requestArray(
        Class<DTO> dtoInterface,
        String url,
        String method,
        Object body,
