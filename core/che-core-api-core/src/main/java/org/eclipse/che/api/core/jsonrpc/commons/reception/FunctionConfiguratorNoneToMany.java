 ...
 * with no params object while the result of a function is a list of objects.
 *
 * @param <R> type of result object
 */
public class FunctionConfiguratorNoneToMany<R> {

  private static final Logger LOGGER = getLogger(FunctionConfiguratorNoneToMany.class);
