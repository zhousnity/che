 ...
 * is short-hand for "calendar". This means values are calculated against the associated calendar,
 * if any. If no calendar is associated, then it is equivalent to having an all-inclusive calendar.
 * A value of "5C" in the day-of-month field means "the first day included by the calendar on or
 * after the 5th". A value of "1C" in the day-of-week field means "the first day included by the
 * calendar on or after Sunday".-->
 *
